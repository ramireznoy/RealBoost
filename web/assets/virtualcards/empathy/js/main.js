...
(function($) {
    ...
    $(function() {
        ...
        */
        ...
        // ------------------------------
        /* jQuery Ajax Share Send Script */
        var shareForm = $('#share-form');
        var $alert = $('.site-alert');
        var $submitshare = shareForm.find('.submitshare');

        shareForm.submit(function() {
            if (shareForm.valid()) {
                NProgress.start();
                $submitshare.addClass("active loading");
                var formValues = shareForm.serialize();

                $.post(shareForm.attr('action'), formValues, function(data) {
                    if (data == 'success') {
                        shareForm.clearForm();
                    } else {
        ...
        var $submit = contactForm.find('.submitmail');
